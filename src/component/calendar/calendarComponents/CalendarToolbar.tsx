  ...
  return (
    <div className="grid grid-cols-3 items-center mb-6">
      ...
      <div className="flex justify-end">
        <div className="relative">
          <select className=" appearance-none w-26.25 rounded-md border border-gray-200 bg-white px-2 py-1.5 pr-7 text-sm text-gray-500 outline-none cursor-pointer focus:ring-2 focus:ring-indigo-300">
